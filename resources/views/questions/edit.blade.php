                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('questions.update',$question->id)}}" method="post">
                            ...
                            {{--  {{method_field('put')}}    helper class--}}

                            @csrf
                            <div class="form-group">
                                <label for="question-title">Question Title Edit</label>
                    ...
                    <strong>{{ $errors->first('title') }}</strong>
                            ...
                            <div class="form-group">
                                <label for="question-body">Question Body Edit</label>
                    ...
                    <strong>{{ $errors->first('body') }}</strong>
                            ...
                            <div class="form-group">
                                <button class="btn btn-outline-primary btn-lg" type="submit">Update & Save</button>
                            </div>
                        </form>
                    </div>
                </div>
